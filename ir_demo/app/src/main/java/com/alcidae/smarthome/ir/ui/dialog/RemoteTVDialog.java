 ...
 *
 * @author zhurongkun
 * @version 2018/4/4 11:34 1.0
 * @time 2018/4/4 11:34
 * @project ir_demo com.alcidae.smarthome.ir.ui.dialog
 * @description
 * @updateVersion 1.0
 * @updateTime 2018/4/4 11:34
 */
...
public class RemoteTVDialog extends BaseRemoteDialog implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mPadLayout = findViewById(R.id.id_dialog_tv_pad_1_ll);
        mNumLayout = findViewById(R.id.id_dialog_tv_pad_num_ll);
        ...
        mPadView = findViewById(R.id.id_dialog_tv_padview);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.id_dialog_title_close:
                dismiss();
                break;
            case (R.id.id_dialog_tv_power_iv):
                power();
                break;
            case (R.id.id_dialog_tv_menu_iv):
                menu();
                break;
            case (R.id.id_dialog_tv_signal_iv):
                sendIr(IRConst.KEY.input);
                break;
            case (R.id.id_dialog_tv_back_iv):
                sendIr(IRConst.KEY.back);
                break;
            case (R.id.id_dialog_tv_volume_up_iv):
                sendIr(IRConst.KEY.volume_up);
                break;
            case (R.id.id_dialog_tv_volume_down_iv):
                sendIr(IRConst.KEY.volume_down);
                break;
            case (R.id.id_dialog_tv_home_iv):
                sendIr(IRConst.KEY.homepage);
                break;
            case (R.id.id_dialog_tv_mute_iv):
                sendIr(IRConst.KEY.mute);
                break;
            case (R.id.id_dialog_tv_num_iv):
                changePadToNum();
                break;
            case (R.id.id_dialog_tv_num_0_iv):
                sendIr(IRConst.KEY.num_0);
                break;
            case (R.id.id_dialog_tv_num_1_iv):
                sendIr(IRConst.KEY.num_1);
                break;
            case (R.id.id_dialog_tv_num_2_iv):
                sendIr(IRConst.KEY.num_2);
                break;
            case (R.id.id_dialog_tv_num_3_iv):
                sendIr(IRConst.KEY.num_3);
                break;
            case (R.id.id_dialog_tv_num_4_iv):
                sendIr(IRConst.KEY.num_4);
                break;
            case (R.id.id_dialog_tv_num_5_iv):
                sendIr(IRConst.KEY.num_5);
                break;
            case (R.id.id_dialog_tv_num_6_iv):
                sendIr(IRConst.KEY.num_6);
                break;
            case (R.id.id_dialog_tv_num_7_iv):
                sendIr(IRConst.KEY.num_7);
                break;
            case (R.id.id_dialog_tv_num_8_iv):
                sendIr(IRConst.KEY.num_8);
                break;
            case (R.id.id_dialog_tv_num_9_iv):
                sendIr(IRConst.KEY.num_9);
                break;
            case (R.id.id_dialog_tv_num_input_iv):
                sendIr(IRConst.KEY.number);
                break;
            case (R.id.id_dialog_tv_num_exit_iv):
                changeNumToPad();
                break;
        }
    }
